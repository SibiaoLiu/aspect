...
{\it Value:} output-muparser-temperature-example
...
{\it Value:} reference density profile
...
{\it Value:} ymax=1.0e6, xtrm=2.200e6, vsub=7.927e-10, ageop=9.46e14, Tm=1673, Ts=273, kappa=1e-6
...
{\it Value:} (((x>0.0) \&\& (x<=xtrm)) ? (Ts + (Tm-Ts)*(1-erfc((ymax-y)/(2*sqrt(kappa*(x/vsub)))))) : (x>xtrm) ? (Ts + (Tm-Ts)*(1-erfc((ymax-y)/(2*sqrt(kappa*ageop))))) :(Tm) )
...
{\it Value:} minimum refinement function
...
{\it Value:} visualization, velocity statistics, temperature statistics
